...
| ---: | --- | ---: | ---: | ---: | ---: | --- | --- | --- | ---: | ---: | ---: | ---: | --- |
| 11 | 是 | 0.555957 | 0.677717 | 0.566787 | 140 | 是 | 是 | 否 | 31.83 | 1.90 | 0.50 | 1417.42 | base_model.model.roberta.encoder.layer.0.attention.self.query |
| 42 | 是 | 0.480144 | 0.691066 | 0.545126 | 100 | 是 | 是 | 否 | 25.54 | 1.64 | 0.48 | 1418.29 | base_model.model.roberta.encoder.layer.0.attention.self.query |
| 123 | 是 | 0.595668 | 0.662574 | 0.653430 | 140 | 是 | 是 | 否 | 24.05 | 1.61 | 0.49 | 1418.29 | base_model.model.roberta.encoder.layer.0.attention.self.query |
| 2026 | 是 | 0.472924 | 0.698805 | 0.530686 | 140 | 否 | 否 | 否 | 32.92 | 1.61 | 0.49 | 1906.45 | base_model.model.roberta.encoder.layer.0.attention.self.query |
| 3407 | 是 | 0.642599 | 0.679509 | 0.527076 | 140 | 是 | 是 | 否 | 25.40 | 1.57 | 0.49 | 1906.45 | base_model.model.roberta.encoder.layer.0.attention.self.query |
