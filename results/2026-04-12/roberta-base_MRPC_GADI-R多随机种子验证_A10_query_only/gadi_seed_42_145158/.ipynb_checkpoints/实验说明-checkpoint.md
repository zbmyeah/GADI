...
- 训练过程最好验证集 Loss：0.420949
- 训练过程最好验证集 Accuracy：0.794118
- 最好结果出现步数：200
...
- 当前实验目录：`/mnt/workspace/GADI/results/2026-04-12/roberta-base_MRPC_GADI-R多随机种子验证_A10_query_only/gadi_seed_42_145158`
- 配置快照：`配置快照.yaml`
- 指标结果：`结果.json`
- 模型权重目录：`模型权重/`
